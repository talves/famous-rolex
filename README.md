#famous-rolex
> An Example of a clock using the ADARTA clock widget.  
> **[Demo Example Here](http://demo.whyfamo.us/rolex/)**

[![Build Status](https://travis-ci.org/talves/famous-rolex.svg?branch=master)](https://travis-ci.org/talves/famous-rolex) [![Dependency Status](https://david-dm.org/talves/famous-rolex.svg)](https://david-dm.org/talves/famous-rolex) [![devDependency Status](https://david-dm.org/talves/famous-rolex/dev-status.svg)](https://david-dm.org/talves/famous-rolex#info=devDependencies)
...
## Release History
 * 2014-11-15   v0.1.0   Generated by the [Yeoman Generator](https://github.com/FamousTools/generator-famous) for [Famo.us](http://famo.us)
